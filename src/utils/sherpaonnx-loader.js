 ...
 * @returns {string|null} Path to the library directory or null if not found
 */
 ...
 * @returns {Promise<any>} The loaded sherpa-onnx-node module
 */
 ...
 * @returns {boolean} True if SherpaOnnx can run in the current environment
 */
